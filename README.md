...
usage: spray-wrapper [-h] [-L] [-u URL] [-p PASSWORDS] [-e EMAILS] [-t TOOL] [-a ATTEMPTS] [-d DELAY] [-x PROXY]

Spray Wrapper v1.0

options:
  -h, --help            show this help message and exit
  -L, --list-modules    List supported modules.
  -u URL, --url URL     Target URL/IP/IP CIDR range to spray if tool requires it (optional).
  -p PASSWORDS, --passwords PASSWORDS
                        Password file to spray.
  -e EMAILS, --emails EMAILS
                        Emails/Usernames file to spray.
  -t TOOL, --tool TOOL  Tool to use (trevorspray/nxc).
  -a ATTEMPTS, --attempts ATTEMPTS
                        The number of passwords to to try and at a time (default is 2).
  -d DELAY, --delay DELAY
                        The delay in seconds between each number of attempts (default is 300).
  -x PROXY, --proxy PROXY
                        HTTP(S) Proxy to feed to command if supported (optional)
```
